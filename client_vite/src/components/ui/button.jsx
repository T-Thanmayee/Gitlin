  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 dark:focus-visible:ring-zinc-300",
  {
    variants: {
      variant: {
        ...
        ghost: "hover:bg-zinc-100 hover:text-zinc-900 dark:hover:bg-zinc-800 dark:hover:text-zinc-50 bg-none",
        link: "text-zinc-900 underline-offset-4 hover:underline dark:text-zinc-50",
        invis:"bg-transparent text-white outline-0 hover:text-zinc-800 dark:bg-transparent dark:text-zinc-50 dark:hover:bg-zinc-800 dark:hover:text-zinc-50",
      },
      size: {
